...
function showIphone () {
    hidePanels();
    document.getElementById("iphoneInventionContent").style.display = "block"; // Opens up the tab when clicked
    document.getElementById("iphoneTab").className = "accordionPanelTab highlight"; // Highlights the tab when clicked
} 
...
function showImac () {
    hidePanels();
    document.getElementById("imacInventionContent").style.display = "block"; // Opens up the tab when clicked
    document.getElementById("imacTab").className = "accordionPanelTab highlight"; // Highlights the tab when clicked
}

function showIpad () {
    hidePanels();
    document.getElementById("ipadInventionContent").style.display = "block"; // Opens up the tab when clicked
    document.getElementById("ipadTab").className = "accordionPanelTab highlight"; // Highlights the tab when clicked
}
